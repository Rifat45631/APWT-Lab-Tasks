...
export default function HomePage() {
  ...
  return (
    ...
    <div className="flex flex-col bg-global-7 w-full min-h-screen">
      ...
      <Header />
      {/* Hero Section */}
      <section className="flex flex-row px-[150px] py-[133px] gap-x-[40px]">
      ...
      {/* Statistics Section */}
      <section className="relative px-[150px] mb-[103px]">
        <div className="absolute top-[53px] left-[185px] w-[1068px] h-[189px] bg-global-1 rounded-[10px] shadow-[0px_4px_114px_#888888ff]" />
        <div className="relative bg-global-7 rounded-[10px] w-[1140px] h-[200px] p-[37px]">
      ...
      {/* Features Section */}
      <section className="flex flex-row px-[184px] py-[54px] gap-x-[170px]">
        <div className="w-[508px] h-[414px]">
          <Image
        ...
        <div className="flex flex-col w-[428px]">
          <h2 className="font-rubik font-medium text-[35px] leading-[50px] text-global-1 mb-[8px]">
            We Provide Many Features You Can Use
          </h2>
          <p className="font-rubik font-normal text-base leading-[30px] text-global-2 mb-[120px]">
      ...
      {/* Pricing Section */}
      <section className="bg-gradient-to-b from-global-5 to-transparent px-[175px] py-[80px]">
      ...
      <section className="px-[150px] mb-[115px]">
        <div className="text-center mb-[120px]">
      ...
      {/* Subscribe Section */}
      <section className="relative px-[150px] mb-[115px]">
        <div className="absolute top-[16px] left-[181px] w-[1077px] h-[250px] bg-global-1 rounded-[10px] shadow-[0px_4px_114px_#888888ff]" />
        <div className="relative bg-global-7 rounded-[10px] w-[1140px] h-[233px] flex flex-row items-center justify-between px-[70px]">
