...
const Header = ({ className = '', ...props }) => {
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col sm:flex-row w-full h-full items-center px-[20px] sm:px-[119px] shadow-[0px_4px_15px_#888888ff] transition-colors duration-300 ${
 ...
 <nav className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-y-4 sm:gap-x-6 w-full ml-[0px] sm:ml-[100px] sm:mr-[100px]">
                ...
                <button
                  ...
                  onClick={() => {
                    if (!isLoggedIn) {
                      ...
                      window.location.href = '/quizzes'; // Redirect to quizzes page
                    }
                  }}
                  className="font-instrument font-normal text-2xl leading-[30px] text-header-1 hover:text-global-3 transition-colors"
                >
