...
const Footer = ({ className = '', ...props }) => {
  return (
    <footer className={`w-full px-[20px] sm:px-[150px] py-12 ${className}`} {...props}>
      <div className="flex flex-col items-center justify-center w-full max-w-[1173px] mx-auto">
        <div className="flex flex-col sm:flex-row justify-between w-full mb-12">
          {/* Company Info */}
          <div className="flex flex-col w-full sm:w-[340px] text-center sm:text-left">
            <Image
            ...
            <div className="flex justify-center gap-x-4 mb-6 sm:justify-start">
              <Image
          ...
          {/* Resource Links */}
          <div className="flex flex-col w-full sm:w-[200px] text-center sm:text-left">
          ...
          {/* Start Exploring */}
          <div className="flex flex-col w-full sm:w-[249px] text-center sm:text-left">
            <h3 className="font-rubik font-medium text-lg leading-[22px] text-global-1 mb-6">
              Start Exploring
            </h3>
            <div className="flex flex-col gap-y-4">
          ...
          {/* Earn Rewards */}
          <div className="flex flex-col w-full sm:w-[154px] text-center sm:text-left">
            <h3 className="font-rubik font-medium text-lg leading-[22px] text-global-1 mb-6">
              Earn Rewards
            </h3>
            <div className="flex flex-col gap-y-4">
